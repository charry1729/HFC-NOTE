//https://www.notion.so/wjwu/async-queryInstantiatedChaincodes-target-useAdmin-0109e37f3f064aa3a5e9c08e4f068bd8
...
channel.queryInstantiatedChaincodes(null, true)//[optional]target, [optional]useAdmin
    .then((chaincodeQueryResponse)=>{
        console.log(chaincodeQueryResponse);
    });
